...
class _SignUpPageState extends State<SignUpPage> {
  ...
  Widget _entryField(String title, String hintText, {bool isPassword = false}) {
    return Container(
  ...
  Widget _emailPasswordWidget() {
    return Column(
      children: <Widget>[
        _entryField("Email","Enter your email address"),
        _entryField("UMKM Name", "Enter your UMKM mame"),
        _entryField("Password", "Enter your password", isPassword: true),
        _entryField("Confirmation Password", "Confirm your password" , isPassword: true),
      ],
    );
  }
